...
def get_jobs(city: str, country_code: str, country, job_title: str, recruiters: list = []):
...
def get_jobs_api_response(city: str, country_code: str, country, job_title: str, recruiters: list = []) -> list[Job]:
