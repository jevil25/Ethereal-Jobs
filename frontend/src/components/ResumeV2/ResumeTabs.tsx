...
interface ResumeTabsProps {
    ...
    updateResumeSection: <K extends keyof FormData>(section: K, data: FormData[K]) => void
}

const ResumeTabs = ({ activeTab, setActiveTab, resumeData, handlePersonalInfoEdit, updateResumeSection }: ResumeTabsProps) => {
  ...
  return (
    <Tabs defaultValue={activeTab} value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value='skills' className='p-6'>
            ...
            updateData={(data: string[]) => handleUpdateResumeSection('skills', data)}
            />
        </TabsContent>
