      ...
      <CardContent className="py-2 px-4 space-y-2">
        ...
        <div className="space-y-1.5 flex flex-col md:flex-row justify-center md:items-center">
          <div>
            {job.job_function && (
              <div>
                <Badge variant="outline" className="bg-gray-50 border-gray-200 text-gray-700 font-medium text-xs">
                  {job.job_function}
                </Badge>
              </div>
            )}
              ...
              <div className="flex flex-wrap gap-1">
                {job.matched_skills && job.matched_skills.map((skill) => (
                  <Badge
                    key={skill}
                    variant="outline"
                    className="bg-green-50 text-green-700 border-green-200 flex items-center gap-0.5 py-0 px-1.5 text-xs"
                  >
                ...
                {job.missing_skills && job.missing_skills.map((skill) => (
                  <Badge
                    key={skill}
                    variant="outline"
                    className="bg-gray-50 text-gray-600 border-gray-200 py-0 px-1.5 text-xs"
                  >
                    {skill}
                  </Badge>
                ))}
